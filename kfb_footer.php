							...
							<div class="row">
								<div class="col-md-3">
									<div class="footer-content">
										<div class="logo-footer"><img id="logo-footer" src="images/kfblogo2.png" alt=""></div>
								...
								<div class="col-md-3">
									<div class="footer-content">
										...
										<ul class="list-icons">
											...
											<li><i class="fa fa-phone pr-10 text-default"></i>(253)-520-3550</li>
					...
					<div class="container">
						<div class="subfooter-inner">
							<div class="row">
										...
										<li><i class="fa fa-phone pr-5 pl-10"></i>(253)-520-3550</li>
										<li><i class="fa fa-envelope-o pr-5 pl-10"></i>Kentfoodbank@gmail.com</li>
									</ul>
										<!-- neal
								<div class="col-md-12">
									<p class="text-center">Copyright © Kent Food Bank <a target="_blank" href="http://htmlcoder.me">HtmlCoder</a>. All Rights Reserved</p>
								</div>
									-->
							</div>
						</div>
